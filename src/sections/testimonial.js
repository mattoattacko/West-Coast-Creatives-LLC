...
const data = [
  ...
  },
  {
    ...
    description:
      'You all did exactly do what I hoped to achieve. Where one Upworker did not manage to complete the project, I was afraid it might have been an impossible exercise but WCC delivered nonetheless!',
    avatar: Avatar4,
    name: 'Marijn V',
    designation: 'AIHR',
    review: 5,
  },
  {
    ...
    description:
      'WCC was a pleasure to work with as it was obvious they knew what they were doing, and had several options at their disposal to ensure the project went smoothly. I look forward to my next issue because I know who to message.',
    avatar: Avatar5,
    name: 'Caleb M',
    designation: 'SDVO',
    review: 5,
